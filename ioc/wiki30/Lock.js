...
define([
    ...
    return declare([EventObserver], {
        ...
        WARNING_DIFF: 55 * 1000, // El warning es mostra aquest nombre de ms abans del timeout
        ...
        _showWarningDialog: function () {
            ...
            // TODO[Xavi] Crear el dialog d'alerta
            ...
            var timeout = 5000; // ALERTA[Xavi] Per les proves
            ...
            // Nou codi:
            // Es crean els dos dialegs, primer el de warning i despres es passa aquest com nextDialog('timeout') <-- s'encarega el Manager

            // Un botó provoca un refresc (lock), i l'altre un cancel (cancel, unlock)
