...
define(function () {
    ...
    return function (data) {
        ...
        for (i = 0; i < data.chunks.length; i++) {
            ...
            $form.append('<div><input value="Tornar" type="submit" data-call-type="cancel_partial"/><input value="Desar" type="submit" data-form-id="form_' + aux_id + '" data-section-id="'+aux_id+'" data-call-type="save_partial"/></div>');
