...
define([
    ...
    "ioc/gui/content/engines/edit_partialRenderEngine"
], function (standardRenderEngine, revisionRenderEngine, htmlRenderEngine, edit_partialRenderEngine) {
    ...
    var /** @type function */
        ...
        _init = function () {
            ...
            _addRenderEngine('edit_partial', edit_partialRenderEngine);
