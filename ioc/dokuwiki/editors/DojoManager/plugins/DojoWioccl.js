    ...
    let WiocclButton = declare(AbstractParseableDojoPlugin, {
        ...
        _addHandlers: function ($node, context) {
            ...
            $node.on('click', function (e) {
                ...
                // Que fa això:
                //      - Creem un tree nou, amb una copia del node arrel
                //      - s'estableix el nom que es mostrarà al treeWidget
                //      - s'afegeixen els childrens com a nodes en lloc de ids
                //      - es passa aquest tree al diàleg
        ...
        _update(editor) {
            ...
            // structure.parseWioccl(editor.getValue(), editor.wioccl);
        ...
        //             let siblingId = structure[structure.siblings[i]].id;
        //
        //             console.log("Era igual el sibling id que el id desat a l'estructura??:", structure.siblings[i], siblingId);
        //             this._removeNode(siblingId, structure);
        //         }
        //     }
        //     structure.siblings = [];
        ...
        //         // del document!
        //         structure._removeChildren(root.id);
        //         // root.children = [];
        //     }
        //
        //
        ...
        //             this._getWiocclChildrenNodes(root.children, root.id, structure));
        //
        //         alert("Check!");
