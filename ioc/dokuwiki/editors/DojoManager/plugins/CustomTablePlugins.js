define([
    ...
    "dojo/text!dojox/editor/plugins/resources/insertTable.html",
    "dojo/text!dojox/editor/plugins/resources/modifyTable.html",
...
//			colored individually or in rows.
    ...
    var TableHandler = declare(_Plugin, {
        ...
        getTableInfo: function(forceNewData){
            ...
            td = this.editor.getAncestorElement("td") || this.editor.getAncestorElement("th");
            ...
            if(tbl){
                ...
                // versió dojo, no te en consideració TH
                // tds.forEach(function(d, i){
                //     if(td==d){tdIndex = i;}
                // });
                // trs = dojo.query("tr", tbl);
