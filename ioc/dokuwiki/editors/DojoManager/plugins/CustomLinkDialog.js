define([
    ...
    // original inclou 2 plugins diferents en un i dona error en carregar les dependències.

    // module:
    //		dijit/_editor/plugins/LinkDialog

    var CustomLinkDialog = declare(_Plugin, {
        // summary:
        ...
        _onDblClick: function(e){
            ...
            if(e && e.target){
                ...
                // ALERTA[Xavi] Només canvia aquesta línia per evitar editar imatges i links interns
                if(tg === this.tag && domAttr.get(t, "data-dw-type") !== "internal_link"){
    ...
    _Plugin.registry["customCreateLink"] = function(){
        return new CustomLinkDialog({command: "customCreateLink"});
    };
