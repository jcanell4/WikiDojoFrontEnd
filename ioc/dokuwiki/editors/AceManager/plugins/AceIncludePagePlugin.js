define([
    ...
    return declare([AbstractAcePlugin], {
        ...
        _showDialog: function () {
            ...
            var edid = 'textarea_' + this._getEditor().id + '_include';
            ...
            tb_mediapopup(
                null,
                {
                    ...
                    options: 'width=650,height=400,scrollbars=yes,resizable=yes', // options pel tercer paràmetre de la funció window.open()
                    url: 'lib/exe/pagemanager.php?filler=true&onselect=dw_mediamanager_item_select_without_align&ns='
                },
                edid
            );
